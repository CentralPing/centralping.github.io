...
- [Logger middleware guide](/middleware/logger/) — log callback
  signature, request metadata fields, header redaction
- [Tracing middleware guide](/middleware/tracing/) — trace context
  propagation, span ID generation, W3C Trace Context support
