...
The parser enforces the [RFC 9110 §5.6.2 `token`](https://www.rfc-editor.org/rfc/rfc9110#section-5.6.2)
and [§5.6.4 `quoted-string`](https://www.rfc-editor.org/rfc/rfc9110#section-5.6.4)
