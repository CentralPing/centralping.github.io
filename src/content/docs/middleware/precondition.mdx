---
title: precondition
description: Conditional request enforcement middleware — requires If-Match or If-Unmodified-Since on unsafe requests for ETag-based optimistic concurrency (RFC 6585 §3).
---
...
- [Testing Patterns](/recipes/testing-patterns/) — ETag round-trip and 304 conditional request testing patterns
